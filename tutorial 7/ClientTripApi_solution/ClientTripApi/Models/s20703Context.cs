...
namespace ClientTripApi.Models
{
    public partial class s20703Context : DbContext
    {
        public s20703Context()
        {
        }

        public s20703Context(DbContextOptions<s20703Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.LogTo(Console.WriteLine) // writes to console generated SQL query
